...
window.isLive = window.location.protocol === 'https:'
...
const getHandBuyout = (handId, betSize) => {
  ...
  return Math.floor(handOdds[handId] * betSize)
}
...
if (!isLive) {
  ...
  console.assert(classNames(class1) === 'container foo', 'classNames #1')
  console.assert(classNames(class2) === 'foo', 'classNames #2')
  console.assert(classNames(class3) === '', 'classNames #3')
